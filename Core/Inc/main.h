...
#define STOP_BUTTON_EXTI_IRQn EXTI0_IRQn
#define EMERGENCY_BUTTON_Pin GPIO_PIN_1
#define EMERGENCY_BUTTON_GPIO_Port GPIOA
#define EMERGENCY_BUTTON_EXTI_IRQn EXTI1_IRQn
#define D6_Pin GPIO_PIN_4
#define D6_GPIO_Port GPIOA
#define D6A5_Pin GPIO_PIN_5
#define D6A5_GPIO_Port GPIOA
